...
public class Appointregister extends HttpServlet{ 
 ...
 // String  email  = request.getParameter("email");
  ...
  String query ="select * from appointment where aid='"+Appointid+"' and mobile='"+mobile+"'  order by aid";
 ...
 // out.println("emp_list " + emp_list);
  ...
  String nextJSP = "/showappointment.jsp";
