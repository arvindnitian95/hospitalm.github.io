...
<br><br><br><br>
 <sql:setDataSource
    ...
    <sql:query var="listUsers"   dataSource="${myDS}">
        SELECT * FROM patient where patienttype='Out Patient';
    </sql:query>
        ...
        <table border="1"  cellpadding="5" width="98%" align="center" style="border:2px solid #000000; ">
            <tr>
                <td colspan=15 align="center"
                    style="background-color:ffeeff" > <h2 style="color: blue;font-weight: bold">Out_Patient List</h2> </td>
           </tr>
            <tr>
                <th>ID</th>
                <th>Name</th>
