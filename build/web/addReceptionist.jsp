...
<h3 style="text-align: center;color: #ff0000; font-size: 40px;">Add Receptionist</h3>
<div class="row">
    <form action="Receptionistconn.jsp" method="get">
<div class="column">
    ...
    <input type="Gmail" id="Mobile" name="gmail" placeholder="Enter Gmail id">
</div>
